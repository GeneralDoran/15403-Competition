...
@TeleOp(name="ColorDetectionPractice", group="Pushbot")
public class ColorDetectionPractice extends Auto_Util {
...
class SamplePipeline extends OpenCvPipeline {
    ...
    void inputToBinary(Mat input) {
        System.out.println("InputToBinaryStarted");
        System.out.println(input);
        System.out.println("InputPrinted");
        //Convert to HSV
    ...
    public String getAnalysis() {
        ...
        if((avg1<16)&&(avg2<16)&&(avg3<16)){objectLocation = "None";return "None\n"+avg1+" \n"+avg2+"\n "+avg3+"";}
